 ...
 * 
 */
public class BrickSoldier extends Unit {
    /**
    ...
    public BrickSoldier () {
        ...
        // for testing.
        Information i =
                new Information("Brick", "I love lamp. I also trident people", "buttons/brick.jpg", null);
        setInfo(i);
    }

    public BrickSoldier (Location3D location, int playerID) {
        this(DEFAULT_IMAGE, location, DEFAULT_SIZE, DEFAULT_SOUND, playerID, DEFAULT_HEALTH,
             InteractiveEntity.DEFAULT_BUILD_TIME);
    }

    public BrickSoldier (Pixmap image,
                    Location3D center,
                    Dimension size,
                    Sound sound,
                    int playerID,
