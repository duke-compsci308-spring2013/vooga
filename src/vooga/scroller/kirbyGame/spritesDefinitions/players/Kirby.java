...
public class Kirby extends Player implements IInputListener {
    ...
    private static final String CONTROLS_FILE_PATH =
            "vooga/scroller/kirbyGame/controls/KirbyMapping";
    ...
    private void intializeStates () {
        ...
        this.addPossibleState(MoveRight.STATE_ID, new MoveRight(this, MOVE_RIGHT, STAND_RIGHT,
                                                                SPEED));
        ...
        this.addPossibleState(KirbyCutterWalkRightState.STATE_ID,
                              new KirbyCutterWalkRightState(this));
    ...
    public void startInhale () {
        ...
        if (getCurrentStateID() == MoveLeft.STATE_ID ||
            getCurrentStateID() == InhaleLeftState.STATE_ID) {
            this.activateState(InhaleLeftState.STATE_ID);
            return;
        }

        if (getCurrentStateID() == MoveRight.STATE_ID ||
            getCurrentStateID() == InhaleRightState.STATE_ID) {
    ...
    public void stopAttackState () {
        this.deactivateState(CutterAttackLeftState.STATE_ID);
    }
