...
import games.scroller.letteradventure.Score;
import games.scroller.letteradventure.SpriteLibrary;
...
public class MainPlayer extends Player implements IInputListener {

    private static final Pixmap E_VIEW = SpriteLibrary.makePixmap(SpriteLibrary.IMAGES_DIRECTORY,
                                                                  "main_bird.gif");
    private static final int HEALTH = 1;
    private static final int DAMAGE = 0;
    private static final int SPEED = 300;
    private static final String INPUT_LOCATION = "games/scroller/angryAvions/LetterMapping";
    ...
    public MainPlayer (GameView gameView, ScrollingManager sm) {
